...
<div class="container">
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <h2 class="card-title h4"><?= htmlspecialchars($profile_user['username']) ?></h2>
        ...
        <div class="col-md-8">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <h3 class="card-title h5 mb-0">Producten van <?= htmlspecialchars($profile_user['username']) ?></h3>
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title h5 mb-0">Reviews van <?= htmlspecialchars($profile_user['username']) ?></h3>
                </div>
                <div class="card-body">
