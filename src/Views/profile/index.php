        ...
        <div class="col-md-4">
            <div class="card mb-4">
                <div class="card-body text-center">
                    <h3 class="card-title"><?= View::e($user['username']) ?></h3>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Forum Topics
                            <span class="badge bg-primary rounded-pill"><?= $stats['topics'] ?></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Forum Reacties
                            <span class="badge bg-primary rounded-pill"><?= $stats['replies'] ?></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Favorieten
                            <span class="badge bg-primary rounded-pill"><?= $stats['favorites'] ?></span>
                        </li>
                    </ul>
                </div>
            </div>
