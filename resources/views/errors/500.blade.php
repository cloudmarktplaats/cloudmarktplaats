<x-layouts.marketing
    title="500 — Iets aan onze kant · Cloudmarktplaats"
    description="Server gaf een fout terug. Ligt aan ons, niet aan jou."
>
    ...
    <section class="mx-auto max-w-2xl px-5 sm:px-8 py-24 sm:py-32">
        ...
        <h1 class="mt-4 text-3xl sm:text-4xl font-bold tracking-display-tighter">Iets aan onze kant</h1>

        <div class="mt-6 text-cmp-text/90 text-[15px] leading-[1.75] space-y-4">
            <p>De server gaf een fout terug. Dat ligt aan ons, niet aan jou.</p>
            <p>
                We hebben de fout automatisch gelogd (zonder je IP-adres — die bewaren we sowieso maximaal
                24 uur). Als je het binnen een paar minuten opnieuw probeert, is er een goede kans dat het
                werkt.
            </p>
            <p>
                Werkt het daarna nog niet? Open een issue op
                ...
                met wat je deed toen het misging. Hoe specifieker, hoe sneller iemand het oplost.
            </p>
        </div>
        ...
        <div class="mt-12 pt-6 border-t border-cmp-border flex flex-wrap gap-3">
            ...
            <a href="{{ url('/') }}" class="cmp-btn cmp-btn-secondary">Naar de homepage</a>
