@php
    ...
    $columns = [
        [
            ...
            'items' => [
                'Account aanmaken (met invite-codes)',
                "Advertentie plaatsen (foto's, EXIF gestript)",
                'Categorieën, zoeken, snuffelen',
                'Contact via relay (geen inbox nodig)',
                'Melden + moderatie',
                'Uit de homelabs — anonieme showcase-feed',
                'Waarderen (upvotes, geen downvotes)',
                'Karma, badges & stats voor nerds',
                'Trust-levels op basis van bevestigde verkopen',
                'Transactie-feedback (verkoper tagt koper, beiden bevestigen)',
                'Teller: apparaten gered van de sloop',
            ],
        ],
        [
            'key'   => 'In aanbouw',
            ...
            'items' => [
                ...
                '"Gezocht"-advertenties',
                'Opgeslagen zoekopdrachten & alerts',
                'Deal weigeren + admin-transactieoverzicht',
                'Sponsoring & donaties on-platform',
            ],
        ],
        [
            'key'   => 'Verkend',
