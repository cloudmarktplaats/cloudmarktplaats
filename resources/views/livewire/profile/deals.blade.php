<div class="mx-auto max-w-2xl px-5 py-10 sm:px-8 sm:py-14">
    ...
    <p class="mt-3 text-sm text-cmp-muted">{{ __('Een verkoper heeft jou als koper gemarkeerd. Bevestig de deals die klopten.') }}</p>
    ...
    <div class="mt-8 space-y-2">
        ...
        @empty
            <p class="text-sm text-cmp-muted">{{ __('Geen openstaande deals om te bevestigen.') }}</p>
        @endforelse
    </div>
</div>
