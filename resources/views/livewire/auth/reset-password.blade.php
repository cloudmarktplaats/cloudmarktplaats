<div class="mx-auto max-w-md rounded-sm border border-cmp-border bg-cmp-surface p-6">
    ...
    <form wire:submit="submit" class="space-y-3">
        ...
        <input type="email" autocomplete="username" wire:model="email" placeholder="{{ __('email') }}" class="w-full rounded border bg-cmp-bg2 p-2" readonly>
        <input type="password" autocomplete="new-password" wire:model="password" placeholder="{{ __('nieuw wachtwoord') }}" class="w-full rounded-sm border-cmp-border p-2 focus:border-cmp-signal focus:ring-cmp-signal" required>
