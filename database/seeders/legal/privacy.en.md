...
Measures we apply include: automatic stripping of photo metadata, encryption of 2FA secrets, two-factor authentication, rate limiting against abuse, and self-hosted infrastructure. No system is 100% secure; report a vulnerability to [privacy@cloudmarktplaats.nl](mailto:privacy@cloudmarktplaats.nl).
